...
damping noise (Table~\ref{tab:fidelity-all})~---~is the cumulative
result of this per-gate saving over a circuit.
...
gates, the fidelity advantage depends on the decomposition depth and
may shrink or vanish; a direct hardware calibration of the exchange
angle, as demonstrated for \textsc{iswap}-family gates, is required to
