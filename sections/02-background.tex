...
The Relational Coherence Theorem rests on two independent pillars of
modern quantum theory: the relational structure of quantum properties,
established empirically by Bell-inequality experiments and articulated
philosophically by relational quantum mechanics, and the dynamical
mechanism of environmental decoherence, which governs how that
relational structure evolves toward the classical limit.
This section reviews each pillar in turn, concluding with Zurek's
theory of einselection, which supplies the physical grounding for
the pointer basis in which the Affinity Tensor is later defined.
...
violations of the CHSH bound by more than nine standard deviations in
polarization-entangled photon pairs.
Subsequent experiments across multiple platforms closed successive
loopholes --- fair sampling, locality, freedom of choice --- and in 2022
the Nobel Prize in Physics recognized this body of work, with Zeilinger's
Nobel Lecture~\cite{Zeilinger2023Nobel} providing a comprehensive
account of loophole-free Bell tests.

The physical content of these results is unambiguous: no theory
assigning predetermined, observer-independent values to quantum
observables can reproduce the quantum-mechanical predictions.
Quantum properties are not intrinsic.
They do not belong to systems in isolation; they emerge through
interaction and in relation to the systems doing the interacting.
This is not an interpretive gloss but a theorem-level constraint on
any future physical ontology.
...
Formally, the quantum state $\rho(S \vert O)$ is indexed to the
observing system $O$.
...
In the present work $\Gamma_S$ is treated as an ordered set of
interaction events rather than a full graph-theoretic structure;
the extension to a weighted interaction graph, in which edge weights
carry coupling strengths, is reserved for future development.
...
Lindblad master equation~\cite{NielsenChuang2000}:
...
coherence-loss mechanism the \RCT~characterizes; their treatment is
...
An arbitrary environmental coupling would merely rotate a superposition
...
This choice transforms the theorem from a formal statement about
...
pointer-state outcomes.
The Affinity Tensor tracks exactly this trajectory, and the
Relational Coherence Theorem formalizes it.
