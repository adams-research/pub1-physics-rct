...
\begin{figure}[htbp]
  ...
  \caption{Affinity Tensor dynamics $\bar\alpha(t)$ for the two-qubit
    ...
    measures local pointer-basis coherence in $\rho_S$, not $S$-bath
    entanglement: a Bell state $\ket{\Phi^+}$ initial would give
    $\bar\alpha(0) = \sqrt{2/3}$ in this pointer basis, not $1$.
