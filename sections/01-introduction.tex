...
and decoherence dynamics under a single relational concept, and (ii)~derives unique, quantitatively distinct predictions regarding the
...
By quantifying the degree of relational participation, we can move beyond fixed
entangling operations and instead tune gate parameters to the specific coherence
budget of a physical substrate.
...
and demonstrate via numerical simulation in Qiskit~\cite{Qiskit2024} and
Cirq~\cite{Cirq2025} that $\URA$ achieves measurable process-fidelity
advantages over fixed gates in high-decoherence regimes.
