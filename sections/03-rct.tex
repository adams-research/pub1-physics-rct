...
on $\rho_S$ between any two times $t_1 < t_2$ preserves diagonal
populations in the pointer basis [part~(iii) below; equivalently, in
the Markovian limit of Prop.~\ref{prop:determination},
$\sum_k L_k^\dagger L_k = \gamma\,\mathbf{I}$], and is therefore
unital: it preserves the maximally mixed state.
